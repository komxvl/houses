...
export const formSchema = z.object({address1: z.string().min(1, "Address line 1 must contain a value"),
...
export const propertySchema = formSchema.and(propertyImagesSchema);